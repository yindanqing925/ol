...
.container-right h2{ font-size:26px; color:red; margin-bottom:30px; padding-left:300px;}
...
">中油会员</div>
 <div class="container">
   ...
   <h1>低碳生活</h1>
   <form id="loginform" action="${pageContext.request.contextPath}/base/login" method="post">
      <ul>
      <li>&nbsp;</li>
      <li>&nbsp;</li>
      <li>&nbsp;</li>
<!--         <li>
        ...
        <li>
        <p>会员卡号：</p>
        <p><input name="telephone" id="phonenum" type="text" class="input-1" /></p>
        </li>
        <li>
		<p>密码：</p>
        <p><input name="" onchange="login();" id="password"  type="password" class="input-1"/></p>
        </li>
        <input name="passwords" id="passwords"  type="hidden" class="input-1"/>
<!--         <li>
        <p>验证码：</p>
        ...
        <li>
        <input name="" type="submit"  class="input-3" value="登录" />  <%-- &nbsp;|&nbsp;  <a href="${pageContext.request.contextPath}/user/query">忘记密码？</a> --%></li>
        <li></li>
      </ul>
      </form>
   </div>
...
<script type="text/javascript">
	...
	function login(){
		...
		document.getElementById("passwords").value = passwd;
		//document.getElementById("loginform").action="${pageContext.request.contextPath}/base/login?telephone="+telephone+"&password="+passwd;
		//document.getElementById("loginform").action="${pageContext.request.contextPath}/base/login";
