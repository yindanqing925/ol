...
public class DesEncrypt {
    ...
    static String keySrc = "!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~";
    ...
    public String getNextString(int length) {
        ...
        for (int i = 0; i < length; i++) {
            int index = random.nextInt(keySrc.length());
            data[i] = keySrc.charAt(index);
        }
    ...
    public static void main(String args[]) {
        ...
        String keycontent = des.getNextString(8);
        des.setKey(keycontent);
        System.out.println(keycontent);
        String str1 = "2017-11-06";
        // DES加密  
